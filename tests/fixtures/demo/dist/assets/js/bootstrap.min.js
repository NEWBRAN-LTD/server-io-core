  ...
  Number(
    (function() {
      ...
      var r = (function(t) {
        ...
        var c = {
          ...
          getSelectorFromElement: function(t) {
            ...
            return (
              e ||
                ((e = t.getAttribute('href') || ''), (e = /^#[a-z]/i.test(e) ? e : null)),
              e
            );
          },
          reflow: function(t) {
      ...
      var s = ((function(t) {
        ...
        var u = { DISMISS: '[data-dismiss="alert"]' };
        ...
        var f = { ALERT: 'alert', FADE: 'fade', SHOW: 'show' };
      ...
      (function(t) {
        ...
        var h = { ACTIVE: 'active', BUTTON: 'btn', FOCUS: 'focus' };
        ...
        var d = (function() {
          ...
          return (
            (e.prototype.toggle = function() {
              ...
              var n = t(this._element).closest(c.DATA_TOGGLE)[0];
              if (n) {
            ...
            (e._jQueryInterface = function(n) {
              return this.each(function() {
                var i = t(this).data(r);
                i || ((i = new e(this)), t(this).data(r, i)), n === 'toggle' && i[n]();
              });
            }),
            o(e, null, [
              {
      ...
      (function(t) {
        ...
        var _ = { interval: 5e3, keyboard: !0, slide: !1, pause: 'hover', wrap: !0 };
        ...
        var p = { NEXT: 'next', PREV: 'prev', LEFT: 'left', RIGHT: 'right' };
        ...
        var T = (function() {
          ...
          return (
            ...
            (h.prototype._slide = function(e, n) {
              ...
              var s = n || (o && this._getItemByDirection(e, o));
            ...
            (h._jQueryInterface = function(e) {
              return this.each(function() {
                ...
                var o = t.extend({}, _, t(this).data());
                (typeof e === 'undefined' ? 'undefined' : i(e)) === 'object' &&
                  t.extend(o, e);
                var r = typeof e === 'string' ? e : o.slide;
                if (
                  (n || ((n = new h(this, o)), t(this).data(a, n)), typeof e === 'number')
                )
                  n.to(e);
      ...
      (function(t) {
        ...
        var d = { toggle: !0, parent: '' };

        var f = { toggle: 'boolean', parent: 'string' };
            ...
            (l.prototype.hide = function() {
              ...
              if (t(this._element).hasClass(g.SHOW)) {
                ...
                if ((t(this._element).trigger(n), !n.isDefaultPrevented())) {
                  ...
                  var o = i === p.WIDTH ? 'offsetWidth' : 'offsetHeight';
      ...
      (function(t) {
        ...
        var g = { BACKDROP: 'dropdown-backdrop', DISABLED: 'disabled', SHOW: 'show' };
          ...
          return (
            ...
            (e._jQueryInterface = function(n) {
              return this.each(function() {
                var i = t(this).data(s);
                if (
                  (i || ((i = new e(this)), t(this).data(s, i)), typeof n === 'string')
                ) {
      ...
      (function(t) {
        ...
        var _ = { backdrop: !0, keyboard: !0, focus: !0, show: !0 };
          ...
          return (
            ...
            (h._jQueryInterface = function(e, n) {
              return this.each(function() {
                ...
                if (
                  (o || ((o = new h(this, r)), t(this).data(a, o)), typeof e === 'string')
                ) {
                  if (void 0 === o[e]) throw new Error('No method named "' + e + '"');
                  o[e](n);
      ...
      (function(t) {
        ...
        var u = { offset: 10, method: 'auto', target: '' };
        ...
        var m = (function() {
          ...
          return (
            (h.prototype.refresh = function() {
              ...
              var o = i === p.POSITION ? this._getScrollTop() : 0;
              (this._offsets = []),
                (this._targets = []),
            ...
            (h._jQueryInterface = function(e) {
              return this.each(function() {
                ...
                var o = (typeof e === 'undefined' ? 'undefined' : i(e)) === 'object' && e;
                if (
                  (n || ((n = new h(this, o)), t(this).data(a, n)), typeof e === 'string')
                ) {
          ...
          return (
            (e.prototype.show = function() {
              ...
              if (
                ...
                var o = t(this._element).closest(f.LIST)[0];

                var s = r.getSelectorFromElement(this._element);
                o && ((i = t.makeArray(t(o).find(f.ACTIVE))), (i = i[i.length - 1]));
                var a = t.Event(u.HIDE, { relatedTarget: this._element });

                var l = t.Event(u.SHOW, { relatedTarget: i });
                if (
                  (i && t(i).trigger(a),
      ...
      (function(t) {
        ...
        var m = { FADE: 'fade', SHOW: 'show' };

        var E = { TOOLTIP: '.tooltip', TOOLTIP_INNER: '.tooltip-inner' };

        var v = { element: !1, enabled: !1 };
          ...
          return (
            ...
            (h.prototype.show = function() {
              ...
              if (this.isWithContent() && this._isEnabled) {
                ...
                var c =
                  this.config.container === !1 ? document.body : t(this.config.container);
                t(o)
            ...
            (h.prototype._setListeners = function() {
              ...
              n.forEach(function(n) {
                if (n === 'click')
                  t(e.element).on(e.constructor.Event.CLICK, e.config.selector, function(
                    t
                  ) {
                    return e.toggle(t);
                  });
            ...
            (h.prototype._enter = function(e, n) {
              ...
              return (
                ...
                e && (n._activeTrigger[e.type === 'focusin' ? T.FOCUS : T.HOVER] = !0),
            ...
            (h.prototype._leave = function(e, n) {
              ...
              if (
                ...
                n ||
                  ((n = new this.constructor(e.currentTarget, this._getDelegateConfig())),
                  t(e.currentTarget).data(i, n)),
                e && (n._activeTrigger[e.type === 'focusout' ? T.FOCUS : T.HOVER] = !1),
      ...
      (function(r) {
        ...
        var f = r.extend({}, s.DefaultType, { content: '(string|element|function)' });

        var _ = { FADE: 'fade', SHOW: 'show' };

        var g = { TITLE: '.popover-title', CONTENT: '.popover-content' };
          ...
          return (
            ...
            (u._jQueryInterface = function(t) {
              return this.each(function() {
                ...
                var n =
                  (typeof t === 'undefined' ? 'undefined' : i(t)) === 'object' ? t : null;
                if (
                  (e || !/destroy|hide/.test(t)) &&
                  (e || ((e = new u(this, n)), r(this).data(h, e)), typeof t === 'string')
                ) {
